...
[![Mind map preview](docs/mindmap.png)](https://perezjeffgl.github.io/ccaf/)

Browse all interactive mind maps on [GitHub Pages](https://perezjeffgl.github.io/ccaf/).

## Course Index

All course and topic mind maps live under `mindmaps/` as `*.mm.md` files.
