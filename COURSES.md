# Claude Partner Network Learning Path - Courses Overview

This document provides an index of the 4 main courses in the Claude Certified Architect – Foundations learning path.
